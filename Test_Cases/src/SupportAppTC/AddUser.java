...
public class AddUser {
  ...
  public void testUNOSearch() throws Exception {
	  ...
	  driver.findElement(By.name("email")).sendKeys("test@support.com");
	  Thread.sleep(200);
	  driver.findElement(By.name("addUser")).click();
      Thread.sleep(200);
      
      
      String expected = "http://ec2-18-221-103-75.us-east-2.compute.amazonaws.com:8080/SupportApp/AddRemoveUserE.jsp";
