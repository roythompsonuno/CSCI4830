...
public class ViewProfile {
  ...
  public void testUNOSearch() throws Exception {
      ...
      Thread.sleep(200);
      driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Supportal'])[2]/following::span[1]")).click();
      Thread.sleep(200);
      
      String expected = "http://ec2-18-221-103-75.us-east-2.compute.amazonaws.com:8080/SupportApp/ProfileE.jsp";
