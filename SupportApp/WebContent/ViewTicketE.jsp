    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-4"><a class="btn btn-primary btn-block btn-lg" role="button" style="height: 60px;" href="SubmitTicket.html">Create Ticket</a></div>
                                    ...
                                    <table class="table table-striped table-bordered table-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Laptop Broke</td>
                                                <td>Assigned</td>
                                                <td class="text-center"><button class="btn btn-info" type="button">Edit</button></td>
                                            </tr>
                                            <tr>
                                                <td>0000001</td>
                                                <td>Medium</td>
